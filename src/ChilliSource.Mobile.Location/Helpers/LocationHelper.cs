...
namespace ChilliSource.Mobile.Location
{
	...
	public static class LocationHelper
	{
		...
		public static Position GetPointAtDistanceFrom(Position startingPoint, double initialBearing, double distanceInKilometres)
		{
			...
			initialBearing = initialBearing.ToRadiants();
			...
			var startLatitudeRadiants = startingPoint.Latitude.ToRadiants();
			var startLongitudeRadiants = startingPoint.Longitude.ToRadiants();
